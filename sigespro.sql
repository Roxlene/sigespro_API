...
51	84	INF	7121	5	1	2024-01-22 18:11:16	2024-01-22 18:11:16
...
46	3	INF	7121	\N	1	84	2024-01-22 18:21:35	2024-01-22 18:30:36
\.
...
33	Inspeccion_equipos	api	\N	\N	1	\N
\.
...
81	73	3	asesor@gmail.com	$2y$10$LvpJOh4XHbddeVd12O8iyOAMavqXTJLSexgnzO8q6At4Ridl4pZi.	\N	\N	\N	\N	1	2024-01-21 01:18:45	2024-01-21 01:18:45	\N
...
89	78	1	roxlenevera3626c@gmail.com	$2y$10$Y9WRP6XZtHQjEXtsotOo8.QWS53GjekVE8bVHc1tNxmtcCpLbSzw6	\N	\N	\N	\N	1	2024-01-22 19:08:50	2024-01-22 19:08:50	\N
...
37	8	0	8	84	2024-01-22 18:13:01	2024-01-22 18:32:04
\.
...
SELECT pg_catalog.setval('administrativo.clasificacion_componentes_id_seq', 9, true);
...
SELECT pg_catalog.setval('administrativo.items_evaluados_id_seq', 19, true);
...
SELECT pg_catalog.setval('proyectos.integrantes_id_seq', 55, true);
...
SELECT pg_catalog.setval('proyectos.notificaciones_id_seq', 154, true);
...
SELECT pg_catalog.setval('proyectos.postulaciones_id_seq', 12, true);
...
SELECT pg_catalog.setval('proyectos.solicitudes_id_seq', 37, true);
...
SELECT pg_catalog.setval('public.migrations_id_seq', 121, true);
...
SELECT pg_catalog.setval('seguridad.auditoria_id_seq', 15, true);
...
SELECT pg_catalog.setval('seguridad.permissions_id_seq', 33, true);
...
SELECT pg_catalog.setval('seguridad.vistas_notificaciones_id_seq', 38, true);
...
SELECT pg_catalog.setval('seguridad.vistas_solicitudes_id_seq', 5, true);
